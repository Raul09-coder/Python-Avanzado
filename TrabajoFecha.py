# Un colegio tiene programado un pago para el dia 15 de febrero de 2020. Si el pago es realizado
# despues de la fecha, se cobran $8 pesos por cada dia transcurrido. El pago es por $5,500.00.

#Importacion de módulos necesarios
...
def esFecha(expFecha):
    ...
    try:
        ...
        dia=int(expFecha[-2:])
        # Intenta generar una fecha a partir del año mes y dia proporcionados.
        datetime.date(anio,mes,dia)
    except ValueError:
        # Si se provoca un error, el programa pasa el control a este bloque.
        return False
    
    # Si no hubo error, se retorna True
    return True

# Funcion que convierte una cadena YYYY/MM/DD a su valor equivalente datetime.
...
def main():
    ...
    _fechapago=""
    # Inicializo una variable para que contenga la fecha compromiso de pago.
